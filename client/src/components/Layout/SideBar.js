...
import SideBack from "../../assets/prominent header.svg";
...
export default function () {
  ...
  return (
    <Grid
      item
      classes={{
        root: [sharedClasses.root, classes.sideBackground].join(" "),
          ...
          >
            <Grid item xs={12}>
              ...
              >
                ...
                <Grid item xs={9}>
                  <NavLink to="/" className={sharedClasses.text}>
                    {" "}
                    تراکنشها{" "}
                  </NavLink>
                </Grid>
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                <Grid item xs={9}>
                  <NavLink to="/setting">
                    <span className={sharedClasses.text}>تنظیمات</span>
                  </NavLink>
                </Grid>
              </Grid>
            </Grid>
